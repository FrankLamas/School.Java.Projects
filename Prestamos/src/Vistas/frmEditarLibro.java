 ...
 * @author falco
 */
public class frmEditarLibro extends javax.swing.JDialog {

    /**
     * Creates new form frmEditarLibro
     */
    public frmEditarLibro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar los datos del libro");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tAutor, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(tClave)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (tClave.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Primero escribe sobre el campo.");
            return;
        }
        String datos[][];
        opLibros op = new opLibros();
        datos = op.buscar(0, tClave.getText());
        if (datos.length<1) {
            JOptionPane.showMessageDialog(this, "No sé encontró este libro, intenta con otro.");
            return;
        }
        tTitulo.setText(datos[0][1]);
        tAutor.setText(datos[0][2]);
        tCantidad.setText(datos[0][3]);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        op.updateDato(tClave.getText(), tTitulo.getText(), tAutor.getText(), Integer.parseInt(tCantidad.getText()));
        JOptionPane.showMessageDialog(this, "Se guardó información.");
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void tClaveKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tClaveKeyPressed
        tTitulo.setText("");
        tAutor.setText("");
        tCantidad.setText("");
    }//GEN-LAST:event_tClaveKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmEditarLibro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmEditarLibro dialog = new frmEditarLibro(new javax.swing.JFrame(), true);
